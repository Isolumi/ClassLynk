...
//        ClassBundle lectureBundle1 = new ClassBundle("CSC111", lectureList1);
//
...
//        ClassBundle lectureBundle2 = new ClassBundle("CSC111", lectureList2);
//
...
//                        "Topics include: object-oriented programming (design principles, encapsulation, composition and inheritance); binary representation of numbers; recursion and mathematical induction; abstract data types and data structures (stacks, queues, linked lists, trees, graphs); the limitations of computation.", bundleList));
...
//        lectureList1.add(tempClass1);
//        lectureList1.add(tempClass2);
//        ClassBundle lectureBundle1 = new ClassBundle("PSY100", lectureList1);
//
//
//        List<ClassBundle> bundleList = new ArrayList<>();
//        bundleList.add(lectureBundle1);
...
//                .set(new Course("Introductory Psychology", "PSY100", "A brief introductory survey of psychology as both a biological and social science. Topics will include physiological, learning, perceptual, motivational, cognitive, developmental, personality, abnormal, and social psychology.", bundleList));
...
//        List<SClass> lectureList1 = new ArrayList<>();
//        lectureList1.add(tempClass1);
//        ClassBundle lectureBundle1 = new ClassBundle("ECO101", lectureList1);
//
...
//        List<SClass> lectureList2 = new ArrayList<>();
//        lectureList2.add(tempClass2);
//        ClassBundle lectureBundle2 = new ClassBundle("ECO101", lectureList2);
//
...
//        ClassBundle lectureBundle3 = new ClassBundle("ECO101", lectureList3);
//
...
//        ClassBundle lectureBundle4 = new ClassBundle("ECO101", lectureList4);
//
...
//        ClassBundle lectureBundle5 = new ClassBundle("ECO101", lectureList5);
//
...
//        ClassBundle lectureBundle6 = new ClassBundle("ECO101", lectureList6);
//
//
//
...
//        tutorialList6.add(tempTut5);
//        tutorialList6.add(tempTut6);
//        ClassBundle tutorialBundle6 = new ClassBundle("ECO101", tutorialList6);
//
//        List<ClassBundle> bundleList = new ArrayList<>();
//        bundleList.add(lectureBundle1);
//        bundleList.add(lectureBundle2);
...
//                .set(new Course("Principles of Microeconomics", "ECO101", "An introduction to economic analysis and its applications: price determination, market structure, decision making by individuals and firms, public policy.", bundleList));
...
//        lectureList1.add(tempClass1);
//        lectureList1.add(tempClass2);
//        ClassBundle lectureBundle1 = new ClassBundle("ECO102", lectureList1);
//
...
//        ClassBundle lectureBundle2 = new ClassBundle("ECO102", lectureList2);
//
...
//        ClassBundle lectureBundle3 = new ClassBundle("ECO102", lectureList3);
//
...
//        ClassBundle lectureBundle4 = new ClassBundle("ECO102", lectureList4);
//
...
//        ClassBundle lectureBundle5 = new ClassBundle("ECO102", lectureList5);
//
//
//
//
...
//        ClassBundle tutorialBundle10 = new ClassBundle("ECO102", tutorialList6);
//
//        List<ClassBundle> bundleList = new ArrayList<>();
//        bundleList.add(lectureBundle1);
//        bundleList.add(lectureBundle2);
...
//        bundleList.add(lectureBundle4);
//        bundleList.add(lectureBundle5);
//        bundleList.add(tutorialBundle10);
//
//
//        this.firestore.document("courses/ECO102")
//                .set(new Course("Principles of Macroeconomics", "ECO102", "An introduction to economic analysis and its applications from a macroeconomic (economy-wide) perspective. Topics covered include international trade and finance, role of money and the banking system, monetary and fiscal policy.", bundleList));
...
//        lectureList1.add(tempClass1);
//        lectureList1.add(tempClass2);
//        ClassBundle lectureBundle1 = new ClassBundle("LIN101", lectureList1);
//
//
...
//        List<SClass> lectureList1 = new ArrayList<>();
//        lectureList1.add(tempClass1);
//        ClassBundle lectureBundle1 = new ClassBundle("HPS100", lectureList1);
//
//
//
//
...
//        lectureList1.add(tempClass1);
//        lectureList1.add(tempClass2);
//        ClassBundle lectureBundle1 = new ClassBundle("BIO120", lectureList1);
//
...
//        ClassBundle lectureBundle2 = new ClassBundle("BIO120", lectureList2);
//
//        List<ClassBundle> bundleList = new ArrayList<>();
//        bundleList.add(lectureBundle1);
//        bundleList.add(lectureBundle2);
...
//        lectureList1.add(tempClass1);
//        lectureList1.add(tempClass2);
//        ClassBundle lectureBundle1 = new ClassBundle("CSB202", lectureList1);
//
//        List<ClassBundle> bundleList = new ArrayList<>();
//        bundleList.add(lectureBundle1);
//
...
//        lectureList1.add(tempClass2);
//        lectureList1.add(tempClass3);
//        ClassBundle lectureBundle1 = new ClassBundle("PHY131", lectureList1);
//
//
...
//        tutorialList5.add(tempTut4);
//        tutorialList5.add(tempTut5);
//        ClassBundle tutorialBundle5 = new ClassBundle("PHY131", tutorialList5);
//
//
//        List<ClassBundle> bundleList = new ArrayList<>();
//        bundleList.add(lectureBundle1);
...
//        List<SClass> lectureList1 = new ArrayList<>();
//        lectureList1.add(tempClass1);
//        ClassBundle lectureBundle1 = new ClassBundle("ENG100", lectureList1);
//
//
//        List<ClassBundle> bundleList = new ArrayList<>();
//        bundleList.add(lectureBundle1);
...
//        lectureList1.add(tempClass1);
//        lectureList1.add(tempClass2);
//        ClassBundle lectureBundle1 = new ClassBundle("AST101", lectureList1);
//
...
//                tutorialList6.add(tempTut5);
//        tutorialList6.add(tempTut6);
//        ClassBundle tutorialBundle6 = new ClassBundle("AST101", tutorialList6);
//
//
//        List<ClassBundle> bundleList = new ArrayList<>();
//        bundleList.add(lectureBundle1);
...
//        List<SClass> lectureList1 = new ArrayList<>();
//        lectureList1.add(tempClass1);
//        ClassBundle lectureBundle1 = new ClassBundle("ESS105", lectureList1);
//
//
//        List<ClassBundle> bundleList = new ArrayList<>();
//        bundleList.add(lectureBundle1);
...
//                .set(new Course("Our home planet", "ESS105", "The nature and evolution of the Earth; plate tectonics; rocks and minerals; volcanism; geological time; fossils; geology of Ontario; environmental issues; and human interactions with the planet.", bundleList));
    }
