...
public class SaveViewTimetableInteractor implements SaveViewTimetableInputBoundary {
    ...
    final FirebaseDataAccessObject saveViewTimetablesDataAccessInterface; // TODO: change
...
//        } else {
//            SaveViewTimetableOutputData timetables = new SaveViewTimetableOutputData(timetableRepository.getTimetables());
...
//    }
    ...
    public void execute(SaveViewTimetableInputData inputData) {
        if (!inputData.loggedIn()) {
            ...
            System.out.print(saveViewTimetablesDataAccessInterface.loadCourses());
        }
    }
